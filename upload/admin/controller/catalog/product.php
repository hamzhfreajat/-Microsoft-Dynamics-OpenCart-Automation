...
class ControllerCatalogProduct extends Controller
{
    ...
    public function axUpdateQuantity()
    {

        $this->load->model('catalog/product');
        $products = $this->model_catalog_product->getProducts();

        $this->openCartAxIntegration($products);
    ...
    public function openCartAxIntegration($products)
    {
        ...
        foreach ($products as $product) {
            ...
            try {
                $quantity = (int) $soapClient -> GetOnhand($param1)->response;
                if ($quantity != 0){
                    $this->db->query("UPDATE " . DB_PREFIX . "product SET quantity = '" . $quantity . "' WHERE product_id = '" . $product["product_id"] . "'");
                }
