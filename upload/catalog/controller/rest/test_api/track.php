...
class ControllerRestTestApiTrack extends Controller {
...
// shows the methods coming from the service
        ...
        $getOnHand =  $soapClient -> GetOnhand($param1)->response;
        var_dump($getOnHand);
...
class OpenCardIntegrationServiceCreateSOLineNewRequest {
    private $salesID;
    private $ItemId;
    private $SalesQty;
    private $SalesPrice;

    public function __construct($sale_id , $sku , $quantity , $price , $discount ){
