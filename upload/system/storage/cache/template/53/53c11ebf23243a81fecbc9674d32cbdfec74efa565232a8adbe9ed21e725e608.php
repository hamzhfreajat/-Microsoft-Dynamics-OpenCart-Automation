...
class __TwigTemplate_4fb12f27dd9f7e570f6ba374de294969970180e88623ea03f0067289ee042bbc extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t}
      ...
      \$.ajax({
      url: 'index.php?route=rest/test_api/track/index&user_token=";
        // line 282
        echo ($context["user_token"] ?? null);
        echo "',
      type: 'post',
